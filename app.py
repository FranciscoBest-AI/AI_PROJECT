# ==========================================
# app.py (BACKGROUND VIDEO SAFE VERSION)
# ==========================================
...
class AdvancedContentGenerator:
    def generate_full_process_script(self, niche):
        ...
        if niche == "Sculpture Carving":
            script_steps = [
                "Step 1: Mark the proportions carefully.",
                "Step 2: Remove excess wood.",
                "Step 3: Shape the structure.",
                "Step 4: Carve fine details.",
...
class ContentManager:
    ...
    def generate_daily_content(self):
        ...
        for niche in self.niches:
            self.contents.append(self.generator.generate_full_process_script(niche))
...
video_jobs = {}  # In-memory job tracker
...
# ------------------------------
# Video Generation in Background
# ------------------------------
def process_video_job(job_id, niche_name):
    try:
        scenes = ["Workshop setup", "Shaping process", "Detail carving", "Sanding", "Final reveal"]
        images = []
        ...
        video_path = f"static/videos/{job_id}.mp4"
        create_video_from_images(images, video_path, duration_per_scene=5, resolution=(720,1280))
        video_jobs[job_id] = {"status": "completed", "video_url": f"/static/videos/{job_id}.mp4"}
